...
ALTER TABLE `employee` ADD COLUMN `emp_id` varchar(30)  NOT NULL AFTER `center_code`;

UPDATE employee SET emp_id = concat(SUBSTRING_INDEX(id, '/', 1),'_',SUBSTRING_INDEX(id, '/', -1))
